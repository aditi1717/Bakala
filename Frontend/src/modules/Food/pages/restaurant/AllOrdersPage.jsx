        ...
        <div className="flex items-center gap-2">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent"
            />
          </div>
          <button
            ...
            className={`p-2.5 border rounded-lg transition-colors relative ${
              hasActiveFilters() 
                ? 'bg-brand-50 border-brand-500 hover:bg-brand-100' 
                : 'bg-gray-50 border-gray-200 hover:bg-gray-100'
            }`}
            aria-label="Filter"
          >
            <Filter className={`w-5 h-5 ${hasActiveFilters() ? 'text-brand-600' : 'text-gray-900'}`} />
            {hasActiveFilters() && (
              <span className="absolute -top-1 -right-1 w-4 h-4 bg-brand-600 rounded-full text-white text-xs flex items-center justify-center font-bold">
                ...
                {dateRangeOptions.map((option) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isSelected && <span className="text-xs font-semibold text-brand-600">Selected</span>}
                    </button>
                  )
                })}
              </div>
            ...
            >
                  ...
                  <div className="p-3 border-b border-gray-200">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-9 pr-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent"
                      />
                    </div>
                  </div>
                            ...
                            <div className="relative flex items-center justify-center">
                              {isRadio ? (
                                ...
                                <input
                                  ...
                                  className="w-5 h-5 border-2 border-gray-300 rounded cursor-pointer transition-all appearance-none checked:bg-brand-600 checked:border-brand-600 focus:ring-2 focus:ring-brand-500 focus:ring-offset-2 relative"
                                  style={{
              ...
              <div className="flex items-center gap-3 px-4 py-3 border-t border-gray-200 bg-white">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-2.5 rounded-lg text-sm font-medium text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
      ...
      <AnimatePresence>
        {showToast && (
          <motion.div
            ...
            className="fixed bottom-24 left-1/2 -translate-x-1/2 z-60 text-white px-4 py-3 rounded-lg shadow-lg flex items-center gap-2"
            style={{ background: BRAND_THEME.gradients.primary }}
          >
