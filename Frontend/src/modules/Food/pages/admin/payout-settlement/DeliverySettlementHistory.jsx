                ...
                {loading ? (
                  ...
                  rows.map((row, index) => (
                    <tr key={`${row.paidAt || "na"}-${index}`} className="hover:bg-slate-50">
                      ...
                      <td className="px-5 py-4 text-sm text-slate-700">{Number(row.restaurantsCount || row.partnersCount || 0)}</td>
                  ...
                  {detailsLoading ? (
                    ...
                    details.rows.map((row) => (
                      <tr key={row.settlementId} className="hover:bg-slate-50">
                        ...
                        <td className="px-5 py-4 text-sm text-slate-700">
                          {Number(row.codOrdersCount || 0) > 0 ? toCurrency(row.codPaidAmount) : "NIL"}
                        </td>
