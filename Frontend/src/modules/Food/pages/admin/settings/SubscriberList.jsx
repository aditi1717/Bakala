    ...
    <div className="p-4 lg:p-6 bg-slate-50 min-h-screen">
      ...
      <div className="mb-4 flex items-center justify-between gap-3">
        ...
        <div className="relative">
          <select className="pl-3 pr-8 py-2 text-xs border border-slate-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500 appearance-none">
