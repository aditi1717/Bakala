      ...
      <>
        ...
        <div className="p-2 lg:p-3 bg-slate-50 min-h-screen overflow-x-hidden w-full" style={{ maxWidth: '100vw', boxSizing: 'border-box' }}>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-3 w-full overflow-hidden" style={{ maxWidth: '100%' }}>
            ...
            <a href="#" className="text-brand-600 hover:text-brand-700 text-xs sm:text-sm font-medium flex items-center gap-1 flex-shrink-0">
              See how it works!
              ...
              <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-3 sm:p-4 w-full overflow-hidden" style={{ maxWidth: '100%', boxSizing: 'border-box' }}>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-1.5 text-sm border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500"
                    />
                  </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 min-w-0">
                        <input
                          ...
                          className="flex-1 min-w-0 px-3 py-1.5 text-sm border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500"
                        />
                        <button
                          type="button"
                          onClick={() =>
                ...
                <div className="flex justify-end gap-2 mt-4">
                  ...
                  <button
                    type="button"
                    onClick={handleSave}
                    className="px-4 py-2 bg-brand-600 text-white rounded-lg hover:bg-brand-700 transition-colors text-xs sm:text-sm font-medium flex items-center gap-1.5"
                  >
                    ...
                    <div className="relative inline-block">
                      {adminImageContent.contentImage ? (
                        ...
                        <label className="cursor-pointer">
                          <div className="w-24 h-24 sm:w-32 sm:h-32 border-2 border-dashed border-slate-300 rounded-lg flex items-center justify-center hover:border-brand-500 transition-colors">
          ...
          {adminActiveTab === "About us" && (
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-3 sm:p-4 w-full overflow-hidden" style={{ maxWidth: '100%', boxSizing: 'border-box' }}>
              <div className="flex items-center gap-2 mb-4">
                <input type="checkbox" className="w-4 h-4 text-brand-600 rounded border-slate-300" defaultChecked />
              ...
              <div className="flex justify-end gap-2 mt-4">
                ...
                <button type="button" onClick={handleSave} className="px-4 py-2 bg-brand-600 text-white rounded-lg hover:bg-brand-700 transition-colors text-xs sm:text-sm font-medium flex items-center gap-1.5">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      type="text"
                      placeholder="#ffffff"
                      className="flex-1 px-3 py-1.5 text-sm border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500"
                    />
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="relative inline-block">
                    {reactHeaderContent.backgroundImage ? (
                      ...
                      <label className="cursor-pointer">
                        <div className="w-40 h-24 sm:w-48 sm:h-32 border-2 border-dashed border-slate-300 rounded-lg flex items-center justify-center hover:border-brand-500 transition-colors">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-3 sm:p-4 max-w-full overflow-hidden">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <select className="w-full px-3 py-1.5 text-sm border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500">
                  <option>3</option>
                  <option>4</option>
                  <option>6</option>
                </select>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-3 sm:p-4 max-w-full overflow-hidden">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input type="checkbox" className="w-4 h-4 text-brand-600 rounded border-slate-300" />
                  <span className="text-xs sm:text-sm text-slate-700">Show available zones</span>
                </div>
              </div>
            </div>
