                              ...
                              <div key={field.key}>
                                ...
                                <div className="relative">
                                  <input
                                    ...
                                    className="w-full px-3 py-2 pr-10 text-xs border border-slate-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500"
                                  />
                                  {isPassword && (
                                    <button
                                      type="button"
