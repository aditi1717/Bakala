      ...
      <div className="w-full mx-auto max-w-7xl">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-4 mb-3">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="px-3 py-1.5 text-xs font-medium bg-brand-600 text-white rounded-lg hover:bg-brand-700 transition-colors flex items-center gap-1"
              >
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <select
                          ...
                          className="w-full px-3 py-2 text-xs border border-slate-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500 appearance-none cursor-pointer"
                        >
                          {fieldTypes.map((type) => (
          ...
          <div className="flex justify-end gap-2">
            ...
            <button
              type="submit"
              className="px-4 py-2 text-xs font-medium bg-brand-600 text-white rounded-lg hover:bg-brand-700 transition-colors"
            >
              Submit
            </button>
          </div>
