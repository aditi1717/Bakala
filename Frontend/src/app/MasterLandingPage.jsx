...
export default function MasterLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-orange-500/30 overflow-hidden relative">
      ...
      <div className="absolute top-[200px] left-[-100px] w-80 h-80 bg-brand-200/40 blur-[100px] rounded-full pointer-events-none z-0" />
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl border-b border-gray-200/50 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3 cursor-pointer group">
            ...
            <span className="text-2xl font-black tracking-tighter italic bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-700">BAKALAA</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-32 max-w-5xl mx-auto bg-white rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.03)] border border-gray-100 p-10">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              ...
              <div className="flex flex-col items-center text-center gap-4 group">
                <div className="w-16 h-16 bg-brand-50 rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
